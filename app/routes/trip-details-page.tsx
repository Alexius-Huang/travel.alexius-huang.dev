...
export default function TripDetailsPage() {
    ...
    const { title, subtitle, description, tags, countryCodes, date: { from, to } } = tripDetails;
        ...
        <div className='centered-max-width-960'>
            <article>
                ...
                <div className='flex flex-row gap-x-[1rem] items-center my-2'>
                    ...
                    <span aria-hidden='true' className='text-xs font-extrabold mb-1 dark:text-gray-500 text-gray-400'>@</span>
                ...
                {tags && <TagList tags={tags} className='v-trans-trip-tags' tagClassName='!text-lg' />}
            </article>
